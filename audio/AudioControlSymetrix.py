...
class SymetricsConverter(object):
    ...
    def btosv(self, stValue: bool) -> int:
        """
        Cenverts db value to symetrix value
        """
...
class FaderControl():
    ...
    def __mute__(self):
        ...
        self.__showmute__()
        self.dev.setMute(muteRcId=self.muteRcId, value=self.sc.btosv(self.mute))
...
class SignalProbe():
    def __init__(self,
        ...
        self.btnProbe = None
        if ((self.btnId > 0) and self.ui):
            self.btnProbe = Button(self.ui, self.btnId)
