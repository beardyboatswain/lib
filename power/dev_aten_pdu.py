...
from usr.dev.dev import iPadAdm
...
btnPowerPDU1O1 = Button(iPadAdm, 7101)
btnPowerPDU1O2 = Button(iPadAdm, 7102)
btnPowerPDU1O3 = Button(iPadAdm, 7103)
btnPowerPDU1O4 = Button(iPadAdm, 7104)
btnPowerPDU1O5 = Button(iPadAdm, 7105)
btnPowerPDU1O6 = Button(iPadAdm, 7106)
btnPowerPDU1O7 = Button(iPadAdm, 7107)
btnPowerPDU1O8 = Button(iPadAdm, 7108)

# btnPowerPDU1_ALL = Button(iPadAdm, 7000)
btnPowerPDU2O1 = Button(iPadAdm, 7201)
btnPowerPDU2O2 = Button(iPadAdm, 7202)
btnPowerPDU2O3 = Button(iPadAdm, 7203)
btnPowerPDU2O4 = Button(iPadAdm, 7204)
btnPowerPDU2O5 = Button(iPadAdm, 7205)
btnPowerPDU2O6 = Button(iPadAdm, 7206)
btnPowerPDU2O7 = Button(iPadAdm, 7207)
btnPowerPDU2O8 = Button(iPadAdm, 7208)

# btnPowerPDU1_ALL = Button(iPadAdm, 7000)
btnPowerPDU3O1 = Button(iPadAdm, 7301)
btnPowerPDU3O2 = Button(iPadAdm, 7302)
btnPowerPDU3O3 = Button(iPadAdm, 7303)
btnPowerPDU3O4 = Button(iPadAdm, 7304)
btnPowerPDU3O5 = Button(iPadAdm, 7305)
btnPowerPDU3O6 = Button(iPadAdm, 7306)
btnPowerPDU3O7 = Button(iPadAdm, 7307)
btnPowerPDU3O8 = Button(iPadAdm, 7308)

# btnPowerPDU1_ALL = Button(iPadAdm, 7000)
btnPowerPDU4O1 = Button(iPadAdm, 7401)
btnPowerPDU4O2 = Button(iPadAdm, 7402)
btnPowerPDU4O3 = Button(iPadAdm, 7403)
btnPowerPDU4O4 = Button(iPadAdm, 7404)
btnPowerPDU4O5 = Button(iPadAdm, 7405)
btnPowerPDU4O6 = Button(iPadAdm, 7406)
btnPowerPDU4O7 = Button(iPadAdm, 7407)
btnPowerPDU4O8 = Button(iPadAdm, 7408)

# btnPowerPDU1_ALL = Button(iPadAdm, 7000)
btnPowerPDU5O1 = Button(iPadAdm, 7501)
btnPowerPDU5O2 = Button(iPadAdm, 7502)
btnPowerPDU5O3 = Button(iPadAdm, 7503)
btnPowerPDU5O4 = Button(iPadAdm, 7504)
btnPowerPDU5O5 = Button(iPadAdm, 7505)
btnPowerPDU5O6 = Button(iPadAdm, 7506)
btnPowerPDU5O7 = Button(iPadAdm, 7507)
btnPowerPDU5O8 = Button(iPadAdm, 7508)

# btnPowerPDU1_ALL = Button(iPadAdm, 7000)
btnPowerPDU6O1 = Button(iPadAdm, 7601)
btnPowerPDU6O2 = Button(iPadAdm, 7602)
btnPowerPDU6O3 = Button(iPadAdm, 7603)
btnPowerPDU6O4 = Button(iPadAdm, 7604)
btnPowerPDU6O5 = Button(iPadAdm, 7605)
btnPowerPDU6O6 = Button(iPadAdm, 7606)
btnPowerPDU6O7 = Button(iPadAdm, 7607)
btnPowerPDU6O8 = Button(iPadAdm, 7608)
